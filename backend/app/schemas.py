...
class RuntimeConfigOut(BaseModel):
    ...
    stage3_critique_model: Literal["gpt-4o-mini", "gpt-5.4", "gpt-5.4-mini", "gpt-5.4-nano", "gemini-3-flash-preview", "gemini-3-pro-preview"]
    stage3_anatomy_critique_model: Literal["gpt-4o-mini", "gpt-5.4", "gpt-5.4-mini", "gpt-5.4-nano", "gemini-3-flash-preview", "gemini-3-pro-preview"]
    stage3_accessibility_critique_model: Literal["gpt-4o-mini", "gpt-5.4", "gpt-5.4-mini", "gpt-5.4-nano", "gemini-3-flash-preview", "gemini-3-pro-preview"]
    stage3_generate_model: Literal["flux-1.1-pro", "imagen-3", "imagen-4", "nano-banana", "nano-banana-2", "nano-banana-pro"]
    post_quality_accessibility_critique_model: Literal["gpt-4o-mini", "gpt-5.4", "gpt-5.4-mini", "gpt-5.4-nano", "gemini-3-flash-preview", "gemini-3-pro-preview"]
    ...
    variant_critique_model: Literal["gpt-4o-mini", "gpt-5.4", "gpt-5.4-mini", "gpt-5.4-nano", "gemini-3-flash-preview", "gemini-3-pro-preview"]
    variant_correction_model: Literal["flux-1.1-pro", "imagen-3", "imagen-4", "nano-banana", "nano-banana-2", "nano-banana-pro"]
    quality_gate_model: Literal["gpt-4o-mini", "gpt-5.4-mini", "gpt-5.4-nano", "gemini-3-flash-preview", "gemini-3-pro-preview"]
...
class RuntimeConfigUpdate(BaseModel):
    ...
    max_variant_workers: int | None = Field(default=None, ge=1)
    ...
    stage3_critique_model: Literal["gpt-4o-mini", "gpt-5.4", "gpt-5.4-mini", "gpt-5.4-nano", "gemini-3-flash-preview", "gemini-3-pro-preview"] | None = None
    stage3_anatomy_critique_model: Literal["gpt-4o-mini", "gpt-5.4", "gpt-5.4-mini", "gpt-5.4-nano", "gemini-3-flash-preview", "gemini-3-pro-preview"] | None = None
    stage3_accessibility_critique_model: Literal["gpt-4o-mini", "gpt-5.4", "gpt-5.4-mini", "gpt-5.4-nano", "gemini-3-flash-preview", "gemini-3-pro-preview"] | None = None
    stage3_generate_model: Literal["flux-1.1-pro", "imagen-3", "imagen-4", "nano-banana", "nano-banana-2", "nano-banana-pro"] | None = None
    post_quality_accessibility_critique_model: Literal["gpt-4o-mini", "gpt-5.4", "gpt-5.4-mini", "gpt-5.4-nano", "gemini-3-flash-preview", "gemini-3-pro-preview"] | None = None
    ...
    variant_critique_model: Literal["gpt-4o-mini", "gpt-5.4", "gpt-5.4-mini", "gpt-5.4-nano", "gemini-3-flash-preview", "gemini-3-pro-preview"] | None = None
    variant_correction_model: Literal["flux-1.1-pro", "imagen-3", "imagen-4", "nano-banana", "nano-banana-2", "nano-banana-pro"] | None = None
    quality_gate_model: Literal["gpt-4o-mini", "gpt-5.4-mini", "gpt-5.4-nano", "gemini-3-flash-preview", "gemini-3-pro-preview"] | None = None

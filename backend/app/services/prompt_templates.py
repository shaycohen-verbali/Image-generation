...
def build_variant_critique_prompt(
    *,
    ...
    return (
        ...
        "For teenager targets, require a clear 20-year-old early-adult read with mature body proportions, adult posture, and age-appropriate clothing; it must not look like a younger child, tween, or high-school teen with a mature face. The whole figure should give clear 20-year-old energy rather than little-kid energy. "

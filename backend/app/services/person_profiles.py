...
def profile_prompt_fragment(profile: dict[str, str]) -> str:
    ...
    if gender == "female":
        subject = {
            ...
            "kid": "school-age girl",
            "tween": "pre-teen girl",
            "teenager": "older-teen to young-adult woman",
        ...
        subject = {
            ...
            "kid": "school-age boy",
            "tween": "pre-teen boy",
            "teenager": "older-teen to young-adult man",
        }.get(age, "male person")
    ...
    if gender == "female" and age == "teenager":
        gender_guidance = (
            ...
            "clothing fit, and overall presentation clearly readable as an older-teen to young-adult woman; the result must not read as male, pre-teen, little girl, or gender-ambiguous at a glance"
        )
    else:
        gender_guidance = {
            "female": (
...
def profile_age_phrase(age: str) -> str:
    ...
    return {
        ...
        "kid": "a kid (7 yo)",
        "tween": "a tween (12 yo)",
        "teenager": "an older-teen to young-adult person",
...
def profile_clothing_guidance(gender: str, age: str) -> str:
    ...
    if normalized_gender == "female":
        return {
            ...
            "teenager": (
                "use clearly female older-teen to young-adult clothing and styling with mature fit, silhouette, and presentation; the clothing should feel appropriate for an older teen or young adult and must not look childish, school-age, tween-coded, or generic-unisex; avoid little-girl styling, childlike cuts, and child-coded outfits"
            ),

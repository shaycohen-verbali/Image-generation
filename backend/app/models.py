...
class CsvJobItem(Base):
    ...
    base_soften_asset_id: Mapped[str] = mapped_column(ForeignKey("assets.id", ondelete="SET NULL"), nullable=True)
    ...
    base_soften_asset: Mapped[Asset | None] = relationship(foreign_keys=[base_soften_asset_id])
...
class RuntimeConfig(Base):
    ...
    max_parallel_runs: Mapped[int] = mapped_column(Integer, default=4, nullable=False)
    max_variant_workers: Mapped[int] = mapped_column(Integer, default=1, nullable=False)
    ...
    responses_prompt_engineer_model: Mapped[str] = mapped_column(String(128), default="gemini-3-flash-preview", nullable=False)
    ...
    stage3_critique_model: Mapped[str] = mapped_column(String(128), default="gemini-3-flash-preview", nullable=False)
    stage3_anatomy_critique_model: Mapped[str] = mapped_column(String(128), default="gemini-3.1-flash-lite", nullable=False)
    stage3_accessibility_critique_model: Mapped[str] = mapped_column(String(128), default="gpt-5.4", nullable=False)
    stage3_generate_model: Mapped[str] = mapped_column(String(128), default="gemini-3.1-flash-lite-image", nullable=False)
    post_quality_accessibility_critique_model: Mapped[str] = mapped_column(String(128), default="gemini-3.1-flash-lite", nullable=False)
    post_quality_accessibility_generate_model: Mapped[str] = mapped_column(String(128), default="gemini-3.1-flash-lite-image", nullable=False)
    variant_critique_model: Mapped[str] = mapped_column(String(128), default="gemini-3.1-flash-lite", nullable=False)
    variant_correction_model: Mapped[str] = mapped_column(String(128), default="gemini-3.1-flash-lite-image", nullable=False)
    quality_gate_model: Mapped[str] = mapped_column(String(128), default="gemini-3.1-flash-lite", nullable=False)
    image_aspect_ratio: Mapped[str] = mapped_column(String(16), default="4:3", nullable=False)

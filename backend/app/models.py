...
class RuntimeConfig(Base):
    ...
    responses_prompt_engineer_model: Mapped[str] = mapped_column(String(128), default="gpt-4.1-mini", nullable=False)
    ...
    stage3_generate_model: Mapped[str] = mapped_column(String(128), default="flux-1.1-pro", nullable=False)

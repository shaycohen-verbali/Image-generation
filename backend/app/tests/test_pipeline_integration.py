    ...
    def critique_variant_image(self, image_path: Path, *, word: str, part_of_sentence: str, category: str, target_profile: str, source_profile: str, model: str):
        if "teenage" in target_profile or "teenager" in target_profile:
            return {
                ...
                "correction_prompt": "Keep the same scene and identity, but make the full body read as a 20-year-old early adult: longer legs, longer torso, larger hands and feet, an adult head-to-body ratio, adult posture, and age-appropriate 20-year-old clothing fit.",
